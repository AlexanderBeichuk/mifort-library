...
//   new Book('123456', '1BLA', 'http://www.angelique-world.ru/cover13.gif', ['HENA', 'Author'],
//     'Кни́га — один из видов печатной продукции: непериодическое издание, состоящее ' +
//     'из сброшюрованных или отдельных бумажных листов (страниц) или тетрадей', ['1', '3', '4']),
...
//     'состоящее из сброшюрованных или отдельных бумажных листов (страниц) или тетрадей', ['2', '6']),
//   new Book('123456', '3BLA', 'https://editus.ru/img/services/verstka/cover_6.jpg', ['HENA'],
//     'Кни́га — один из видов печатной продукции: непериодическое издание, ' +
//     'состоящее из сброшюрованных или отдельных бумажных листов (страниц) или тетрадей', ['2', '5']),
//   new Book('123456', '4BLA', 'http://hpclub.ru/wp-content/uploads/2013/02/newhpcover.jpg', ['HENA'],
//     'Кни́га — один из видов печатной продукции: непериодическое издание, ' +
//     'состоящее из сброшюрованных или отдельных бумажных листов (страниц) или тетрадей',  ['3', '6']),
//   new Book('123456', '5BLA', 'https://cdn.shazoo.ru/82030_t1QMGU8HPc_ps.jpeg', ['HENA'],
//     'Кни́га — один из видов печатной продукции: непериодическое издание, ' +
//     'состоящее из сброшюрованных или отдельных бумажных листов (страниц) или тетрадей', ['6', '1', '2']),
...
//     'Кни́га — один из видов печатной продукции: непериодическое издание, ' +
//     'состоящее из сброшюрованных или отдельных бумажных листов (страниц) или тетрадей', ['6', '2']),
...
//     'Кни́га — один из видов печатной продукции: непериодическое издание, состоящее ' +
//     'из сброшюрованных или отдельных бумажных листов (страниц) или тетрадей', ['6', '1', '2']),
//   new Book('123456', '2BLA', 'https://primepublish.ru/content/images/new-elements/elems/step-3-9.png', ['HENA'],
//     'Кни́га — один из видов печатной продукции: непериодическое издание, ' +
//     'состоящее из сброшюрованных или отдельных бумажных листов (страниц) или тетрадей', ['6', '1', '2']),
//   new Book('123456', '3BLA', 'https://editus.ru/img/services/verstka/cover_6.jpg', ['HENA'],
